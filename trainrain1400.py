...
from DerainDataset import prepare_data_Rain1400, Dataset
from utils import *
from torch.optim.lr_scheduler import MultiStepLR
from SSIM import *
from network3 import Network,print_network
...
parser.add_argument("--save_path", type=str, default="logs/Rain1400", help='path of log files')
parser.add_argument("--save_freq",type=int,default=1,help='save intermediate model')
parser.add_argument("--data_path",type=str, default="../Rain12600",help='path to training data')
...
def main():
    ...
    for epoch in range(initial_epoch, opt.epochs):
        ...
        for i, (input_train, target_train) in enumerate(loader_train, 0):
            ...
            loss1 = criterion1(target_train, out_train)
            #loss2 = criterion2(target_train, out_train)
            loss = -pixel_metric+loss1#+loss2
            ...
            print("[epoch %d][%d/%d] loss: %.4f, pixel_metric: %.4f,loss1: %.4f，PSNR: %.4f" %
                  (epoch+1, i+1, len(loader_train), loss.item(), pixel_metric.item(),loss1.item(), psnr_train))
...
if __name__ == "__main__":
    prepare_data_Rain1400(data_path=opt.data_path, patch_size=100, stride=100)
    main()
