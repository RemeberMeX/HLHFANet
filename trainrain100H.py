...
parser.add_argument("--save_path", type=str, default="logs/Rain100H", help='path of log files')
...
if __name__ == "__main__":
    prepare_data_Rain100H(data_path=opt.data_path, patch_size=100, stride=100)
    main()
