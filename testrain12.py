...
parser.add_argument("--data_path", type=str, default="./input/Rain12", help='path to training data')
parser.add_argument("--save_path", type=str, default="./output/Rain12", help='path to save results')
