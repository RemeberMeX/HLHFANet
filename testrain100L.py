...
parser.add_argument("--logdir", type=str, default="logs/Rain100L", help='path to model and log files')#save model
parser.add_argument("--data_path", type=str, default="./input/Rain100L/", help='path to training data')
parser.add_argument("--save_path", type=str, default="./output/Rain100L", help='path to save results')#save image
