...
from DerainDataset import prepare_data_Rain800, Dataset
from utils import *
...
parser.add_argument("--save_path", type=str, default="logs/Rain800", help='path of log files')
parser.add_argument("--save_freq",type=int,default=1,help='save intermediate model')
parser.add_argument("--data_path",type=str, default="../Rain800",help='path to training data')
